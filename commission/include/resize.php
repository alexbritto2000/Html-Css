...
class SimpleImage {
  ...
  if( $permissions != null) {
   ...
   /*function resize($width,$height) {
      ...
      imagecopyresampled($new_image, $this->image, 0, 0, 0, 0, $width, $height, SimpleImage::getWidth(), SimpleImage::getHeight());
...
?>
<!--<script language="javascript" src="zoomphoto.js"></script>
