...
$table_name="`".DB_PREFIX."_partners_section`";
$current_page="partners_section.php";
 ...
 if(!empty($_FILES["upload_file"]) && $_FILES["upload_file"]["error"]!=4) {
	...
	if ($_FILES['upload_file']['name'] != "") {
		...
		{ 
			...
			$parts=explode(".",$v);
			$v=$parts[0].".png";
			$originalpath = "../webuploads/original/partners/".$v;
			$thumbnailpath = "../webuploads/thumb/partners/".$v;
			move_uploaded_file($source,$originalpath);
			include_once('../include/imgresize.php');
			resize($originalpath, $thumbnailpath, 75, 60);
		}
		else
		{ 
...
if(!empty($_POST["submit_action"]) && (!empty($_POST["edit_action"]) || !empty($_POST["add_action"]))){   
	...
	if(!empty($_POST["edit_action"])){
		$sql="UPDATE $table_name SET `content_logo`='".$v."',`modified_date`='".$datetime."' WHERE `web_id`='".$db_cms->removeQuote($_POST["edit_action"])."'";
	}
	else{
		$sql="INSERT INTO $table_name(`content_logo`,`created_date`) VALUES ('".$v."','".$datetime."')";
	}
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Partners Section</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header col-xs-11">
                            ...
                            if(!empty($_REQUEST["action"])){
                                ?>
                                <h3 class="box-title"><?php echo ucfirst($_REQUEST["action"]);?> Partner Sections</h3>
                        ...
                        <form role="form" class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box-body">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Partner Sections<span class="star">*</span>:</label>
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <p class="help-block">(Required Image Size (Width*Height): 75*60. Upload .jpg, .jpeg, .gif, .png)</p>
                        ...
                        <form role="form" class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box-body">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Partner Sections</label>
                                    <div class="col-sm-6">
                                            <div>
                                                <img src="../include/image.php?width=500&amp;height=190&amp;cropratio=125:47&amp;image=<?php echo $sitepath;?>webuploads/thumb/partners/<?php echo $img_path;?>" alt="Image" style="width:500px;"/>
                                            </div>
                                            <br/>
                                    </div>
                                </div> 
                            ...
                            <table id="manage_banner" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align:center">Partner Sections</th>
                                    <th>Action</th>
                                </tr>
                                </thead>
                                <tbody>
                                ...
                                if($res!=FALSE){
                                    ...
                                    foreach ($res as $row){
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <img src="../include/image.php?width=250&amp;height=95&amp;cropratio=125:47&amp;image=<?php echo $sitepath;?>webuploads/thumb/partners/<?php echo $row["content_logo"];?>" alt="Image" style="width:150px;"/>
                                            </td>
