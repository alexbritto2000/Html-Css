...
$table_name="`".DB_PREFIX."_testimonials`";
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header col-xs-11">
                            ...
                            if(!empty($_REQUEST["action"])){
                                ?>
                                <h3 class="box-title"><?php echo ucfirst($_REQUEST["action"]);?> Testimonials Section</h3>
                        ...
                        if(!empty($_REQUEST["action"])){
                            ...
                            if($_REQUEST["action"]=="edit" || $_REQUEST["action"]=="add"){
                                ...
                                <form role="form" class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-xs-2">Author name<span class="star">*</span>:</label>
                                        <div class="col-xs-6">
                                            <div class="form-group">
                            ...
                            elseif($_REQUEST["action"]=="view"){
                                ...
                                <form role="form" class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-xs-2">Author Name</label>
                                        <div class="col-xs-6">
