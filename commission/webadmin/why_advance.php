...
$table_name="`".DB_PREFIX."_advance`";
$current_page="why_advance.php";
        ...
        if (validate_image($_FILES["upload_file"])) {
            if ($_FILES['upload_file']['name'] != "") {
                ...
                { 
                    ...
                    $parts=explode(".",$v);
                    $v=$parts[0].".png";
                    $originalpath = "../webuploads/original/services/".$v;
                    $thumbnailpath = "../webuploads/thumb/services/".$v; 
                    move_uploaded_file($source,$originalpath);
                    include_once('../include/imgresize.php');
                    resize($originalpath, $thumbnailpath, 263, 184); 
                }
                else
                { 
...
if(!empty($_POST["submit_action"]) && (!empty($_POST["edit_action"]) || !empty($_POST["add_action"]))){  
			if(!empty($_POST["content_title"])){
                ...
                if(!empty($_POST["edit_action"])){
                    $sql="UPDATE $table_name SET `content_title`='".$db_cms->removeQuote(get_entity($_POST["content_title"]))."',`content_image`='".$v."',`modified_date`='".$datetime."' WHERE `web_id`='".$db_cms->removeQuote($_POST["edit_action"])."'";
                }
                else{
                    $sql="INSERT INTO $table_name (`content_title`, `content_image`,`created_date`) VALUES ('".$db_cms->removeQuote(get_symbol($_POST["content_description"]))."','".$v ."','".$datetime."')";
                }
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Why advance?</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header col-xs-11">
                            ...
                            if(!empty($_REQUEST["action"])){
                                ?>
                                <h3 class="box-title"><?php echo ucfirst($_REQUEST["action"]);?> Why advance?</h3>
                                <?php
                            }
                            else{
                                ?>
                        ...
                        if(!empty($_REQUEST["action"])){
                               ...
                               <!-- <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-6">
                                            ...
                                            <div>
                                                <img src="../include/image.php?width=200&amp;height=200&amp;image=<?php echo $sitepath;?>webuploads/thumb/services/<?php echo $img_path;?>" alt="Image"/>
                                            </div>
                                            <br/>
                                        <?php  }  ?>
                                        <div class="form-group">
                                            <input type="file" id="upload_file" name="upload_file" accept=".jpeg, .jpg, .png, .gif"   onchange="return test();"/>
                                            <p class="help-block">(Required Image Size (Width*Height): 263*184. Upload .jpg, .jpeg, .gif, .png)</p>
                            ...
                            elseif($_REQUEST["action"]=="view"){
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-6">
                                        <div style="padding: 7px 0">
                                           <img src="<?=$sitepath?>webuploads/thumb/services/<?=$img_path;?>" border="0" class="imgborder" id="web_image" style="vertical-align:top;" alt="" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                if($res!=FALSE){
                                    ...
                                    foreach ($res as $row){
                                        ...
                                        <tr>
											...
											<td><img src="../include/image.php?width=250&amp;height=95&amp;cropratio=125:47&amp;image=<?php echo $sitepath;?>webuploads/thumb/services/<?php echo $row["content_image"];?>" alt="Image" style="width:150px;"/>
                                            </td>
                                            <td width="263" style="vertical-align: middle">
